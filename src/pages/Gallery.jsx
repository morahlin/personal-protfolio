...
const Gallery = () => {
  ...
  return (
    <section ref={ref} id="projects" className="flex flex-col items-center mt-40 md:mt- justify-center">
      <h2 className="font-bold text-center lg:text-[48px] sm:text-[35px] xs:text-[30px] text-[32px] lg:leading-[40px]">Gallerys</h2>
      ...
      <div className="mt-20 flex flex-wrap gap-12 items-center justify-center xl:grid grid-cols-3 ">
        {projects.map((project, index) => (
          <motion.div
            ...
            animate={controls}
            initial="hidden"
            className="" key={project.name}
          >
            <motion.div className="relative rounded-2xl w-[330px] lg:w-[350px] lg:h-[px] h-[300px] p-4 bg-[#0f172a]" >
              ...
              <div className="flex gap-8 items-end m-3 card-img_hover z-[2]">
                <button
                  ...
                  className="w-10 h-10 rounded-full flex justify-start items-center cursor-pointer">
